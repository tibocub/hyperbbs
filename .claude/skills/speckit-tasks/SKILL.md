...
Principle VI), generate a failing-first `brittle` test task ahead of every implementation task that
changes behavior, consistent with hypergraph's own test conventions. Only skip test tasks for work with
